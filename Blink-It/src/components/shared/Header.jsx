  ...
  return (
    <header className="_nav px-2 sm:px-0">
      <div className="_header sm:flex h-full">
        ...
        <div className="login-button flex items-center justify-center cursor-pointer sm:hover:bg-gray-50 max-w-[80px] lg:max-w-[160px] w-full">
      <span className="font-medium text-default hidden sm:block">
        <a href='_blank' className="login-link">Login</a>
      </span>
